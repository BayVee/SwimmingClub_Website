			...
			<div class="drop-bar-container">
				<div class="container" style="background-color:transparent;">
					<div class="drop-bar sixteen columns far-edge">
						...
						<?php endif; ?>
						<?php if( $agilitySettings->op( 'enable-drop-container' ) ) : ?>
                        <a href="#" id="drop-panel-expando">Club Member's Login +</a>
						<?php endif; ?>
					</div>
				</div>
			</div>
            ...
            <div id="header-inner" class="sixteen columns over">
				...
				<?php 
					...
					wp_nav_menu( array( 
						...
						'container'			=> 'nav',
						'container_class'	=> 'menu-primary-container site-navigation main-navigation nav-default-right two-thirds column omega',
