...
<body <?php body_class(); ?> style="background-color:<?php echo $bg_color; ?>">	    
    ...
    <div class="wrapper_header">
        <div id='header'>
            <div class="logo">
                ...
                <a href="<?php echo home_url(); ?>"><img src="<?php echo get_template_directory_uri().'/images/UshirtLogo.png'; ?>" alt="<?php echo bloginfo('name'); ?>"/></a>
                <?php else: ?>
                ...
                <?php if(is_singular() && !is_front_page()): ?>
                    <span style="color:#09C;" class="title<?php if(cpotheme_get_option('cpo_general_texttitle') == 0){ ?> hidden<?php } ?>"><a href="<?php echo home_url(); ?>"><?php bloginfo('name'); ?></a></span>
                <?php else: ?>
                    <span style="color:#09C;" class="title<?php if(cpotheme_get_option('cpo_general_texttitle') == 0){ ?> hidden<?php } ?>"><a href="<?php echo home_url(); ?>"><?php bloginfo('name'); ?></a></span>
                <?php endif; ?>
    ...
    <div class="wrapper_header">
        <div id='tagline'>
            <span class="taglinesetting"><?php echo stripslashes(cpotheme_get_option('cpo_home_tagline')); ?></span> 
        </div>
    </div>
    <?php } ?>
