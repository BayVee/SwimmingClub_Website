<?php
/**
 * Template Name: Home + Blog (Standard)
 *
 * @package Agility
 * @since Agility 1.0
 */
...
?>
		...
		<!-- Begin page-home-blog-standard.php 
		============================================ -->
			...
			<div id="primary" class="site-content">
				...
				<div id="content" >
					...
					<div class="row">
						...
						<div id="blog-standard" class="blog-layout blog-layout-standard eleven columns cf">

							<?php if( $agilitySettings->op( 'blog-display-title' ) ): ?>
								<h5 class="entry-title page-title"><?php echo $agilitySettings->op( 'blog-title' ); ?></h5>
							<?php endif; ?>
		...
		<!-- end page-home-blog-standard.php -->
