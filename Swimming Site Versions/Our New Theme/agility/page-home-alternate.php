...
$slider_img_size = 'natural_640';
if( $agilitySettings->op( 'home-slider-crop' ) ) $slider_img_size = 'crop_640';
?>

		<!-- Begin page-home-alternate.php 
		============================================ -->
			...
			<div id="primary" class="site-content">
				...
				<div id="content" >
					...
					<div class="one-third column">
						<h2 class="entry-title page-title alternate"><?php the_title(); ?></h2>
						<?php 
							$tagline = $agilitySettings->op( 'home-tagline' );
							if( $tagline ): ?>
							<div class="tagline medium"><?php echo $tagline; ?>
								<?php if( $agilitySettings->op( 'home-tagline-fleuron' ) ): ?><?php endif; ?>
							</div>
						<?php else: ?>
